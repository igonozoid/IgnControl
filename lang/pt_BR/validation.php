...
return [
    ...
    | como as regras de tamanho. Fique à vontade para ajustar cada uma
    | dessas mensagens.
    |
    */
    ...
    | para atributos usando a convenção "attribute.rule" para nomear
    | as linhas. Isso torna rápido especificar uma linha de idioma
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir são usadas para trocar nosso placeholder de
