<div class="max-w-5xl mx-auto py-5 px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <a href="{{ route('reports.dre') }}" wire:navigate
            class="block bg-white dark:bg-neutral-800 shadow-sm rounded-lg p-4 hover:ring-1 hover:ring-indigo-300 dark:hover:ring-indigo-500">
        ...
        <a href="{{ route('reports.cost-centers') }}" wire:navigate
            class="block bg-white dark:bg-neutral-800 shadow-sm rounded-lg p-4 hover:ring-1 hover:ring-indigo-300 dark:hover:ring-indigo-500 sm:col-span-2">
